...
export async function PUT(request: Request, { params }: Params) {
  ...
  const effStartTz =
    startTimezone !== undefined ? startTimezone : existingStartTz;
  const effEndTz =
    endTimezone !== undefined ? endTimezone : (existingEndTz ?? effStartTz);
  ...
  const activity = await prisma.activity.update({
    ...
    data: {
      ...
      ...(startTime !== undefined && {
        startTime: toTimestamp(startTime, day.date, effStartTz),
      }),
      ...(startTimezone !== undefined && { startTimezone }),
      ...(endTime !== undefined && {
        endTime: toTimestamp(endTime, day.date, effEndTz),
      }),

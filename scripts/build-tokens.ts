...
// Phase 2(#301)에서 정본 토큰이 일시적으로 비워질 수 있음(디자이너 합류 전 중성
// 유지). 따라서 필수 카테고리 강제 대신 "최소 빈 블록 렌더 허용"으로 완화.
const REQUIRED_CATEGORIES: readonly string[] = [];
...
function main(): void {
  ...
  // Phase 2(#301) 이후 정본이 비어 있을 수 있음 — 디자이너 합류 전 중성 유지.
  // 빈 토큰도 허용하여 BEGIN:tokens/END:tokens 블록이 결정적으로 비어 있게 한다.

...
- [ ] T020 [US2] 미리보기 카탈로그에 폼 6종 섹션 추가 — `src/app/(dev)/components/page.tsx`에 "Migrated Forms" 섹션 신설, 6종을 더미 Server Action과 함께 렌더. [artifact: src/app/(dev)/components/page.tsx] [why: form-migration]

...
- [ ] T015 `changes/622.feat.md` 단편 추가 — What 한 문장 + Why 한 문장, 합쇼체. HOW 일체 금지. release build 시 towncrier 가 단편을 소비하므로 미체크 유지(소비 후 drift 부재 판정 회피, spec 031 패턴) [artifact: changes/622.feat.md] [why: release-bookkeeping]
